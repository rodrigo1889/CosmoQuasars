...
j.add_chain(dultzin,parameters=names,name="Base+xA")
j.add_chain(lusso,parameters=names,name="Base+nUVX")
j.configure(shade=True,kde=[1.5,1.5,1.5],shade_alpha=[0.3,0.3,0.3],colors=["#011638","#23CE6B","#F08080","#1B9AAA","#F7D488","#136F63"])
