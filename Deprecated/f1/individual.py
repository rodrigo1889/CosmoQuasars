...
j.configure(shade=True,kde=[1.5,1.5,False],shade_alpha=0.5,colors=["#011638","#23CE6B","#F08080"])
#fig3 = j.plotter.plot(extents=[[0.25, 0.4], [-3.0,0.0]])
fig3 = j.plotter.plot(parameters=names[:2],extents=[[0.2,0.45],[-1.5,0.0]])
